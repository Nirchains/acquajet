        ...
        array(
            ...
            'attr' => array(
                'general' => array(
                    ...
                    'show_subject' => array(
                        'type' => 'checkbox',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_SUBJECT_FIELD'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_SUBJECT_FIELD_DESC'),
                        'values' => array(
                            '0' => 'No',
                            '1' => 'Yes'
                        ),
                    ...
                    'subject' => array(
                        'type' => 'text',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_SUBJECT'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_SUBJECT_DESC'),
                        'std' => '',
                        'depends' => array('show_subject' => '0'),
                    ),
                    'show_message' => array(
                        'type' => 'checkbox',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_MESSAGE_FIELD'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_MESSAGE_FIELD_DESC'),
                        'values' => array(
                            '0' => 'No',
                            '1' => 'Yes'
                        ),
                    ...
                    'host' => array(
                        ...
                        'title' => 'Host',
                        'desc' => '',
                        'std' => 'qql267.acquajet.com',
                        'depends' => array('send_to_bbdd' => '1')
                    ),
                    'bbdd' => array(
                        'type' => 'text',
                        'title' => 'BBDD',
